package com.qieyou.qieyoustore.widget;
...
public class TransLinearlayout extends LinearLayout {
    ...
    public TransLinearlayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static interface OnLayoutTranslateListener {
        void onLayoutTranslate(TransLinearlayout view, float xFraction);
    }
}
