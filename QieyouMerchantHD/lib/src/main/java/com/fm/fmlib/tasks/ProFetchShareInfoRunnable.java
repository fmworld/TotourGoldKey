 ...
 */
public class ProFetchShareInfoRunnable extends TokenCheckedRunnable<StoreShareEntity> {
    private String pro_id;
    public ProFetchShareInfoRunnable(String pro_id){
        this.pro_id = pro_id;
    }
    @Override
    public StoreShareEntity doBackground() throws RetrofitError {
        return TourApplication.instance().getmTotour()
                ...
                .fetchStroeShareInfo(TourApplication.instance().getToken(), pro_id, InnController.InnType.item.toString());
    }
